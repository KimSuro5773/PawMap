...
// 동물병원 검색 훅
export const useSearchHospitals = (location, options = {}, queryOptions = {}) => {
  return useQuery({
...
// 애견 미용샵 검색 훅
export const useSearchGrooming = (location, options = {}, queryOptions = {}) => {
  return useQuery({
...
// 애견 숙박시설 검색 훅
export const useSearchAccommodation = (location, options = {}, queryOptions = {}) => {
  return useQuery({
...
// 현재 위치 기반 검색 훅
export const useSearchNearby = (searchType, position, options = {}, queryOptions = {}) => {
  return useQuery({
